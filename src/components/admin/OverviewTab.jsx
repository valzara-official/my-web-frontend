...
export default function OverviewTab({ nodes, users, totalClicks, systemStats }) {
  // Chỉ lọc ra các tài khoản là User thông thường (loại trừ Admin và Leader ra khỏi số lượng user)
  ...
  return (
    <div className="space-y-6">
      {/* 4 Ô THỐNG KÊ CỐT LÕI (Đúng yêu cầu: Tổng nodes, Tổng user, Tổng lượt truy cập, Tổng thời gian truy cập) */}
      ...
      {/* PHẦN BIỂU ĐỒ TRỰC QUAN KHÔNG BỊ TRÙNG LẶP */}
